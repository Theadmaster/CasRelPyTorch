...
parser.add_argument('--max_len', type=int, default=760)
parser.add_argument('--dataset', default='coronary_angiography', type=str, help='define your own dataset names')
parser.add_argument("--bert_name", default='nghuyong/ernie-3.0-base-zh', type=str, help='choose pretrained bert name')
